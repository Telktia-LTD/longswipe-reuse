...
func (maker *JWTMaker) CreateToken(user interfacesx.UserResponse, duration time.Duration) (string, *AuthPayload, error) {
...
func (maker *JWTMaker) VerifyToken(token string) (*AuthPayload, error) {
